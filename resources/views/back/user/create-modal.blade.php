        ...
        <div class="modal-body">
          <form action="{{ url('users')}}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="name" class="form-control @error('name') is-ivalid @enderror" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="mb-3">
                  ...
                  <input type="email" name="email" id="email" class="form-control @error('email') is-ivalid @enderror" value="{{ old('email') }}">
                  @error('email')
                      <div class="invalid-feedbck">
                          {{ $message }}
                      </div>
